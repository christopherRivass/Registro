	...
	<body>
		<div>
			<form action="save/saveInfo.php" method="POST">
				<h4>Put your DNI</h4>
				<input type="text" name="DNI" placeholder="000012122343">
				<h4>Tell me your name</h4>
				<input type="text" name="itName" placeholder="Francisco Rodriguex">
				<h4>How old are you</h4>
				<input type="number" name="years" placeholder="18">
				...
				<input type="text" name="day" placeholder="Mornin,Night">
